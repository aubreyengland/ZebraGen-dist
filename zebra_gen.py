...
def lookup_dept_name(ext_number_last3) -> str:
    """
...
def lookup_site_info(formatted_site_number: str) -> str:
    """Lookup the site info in the site_info.json file, based on the last three digits of the site name, and return the full site name.
...
def build_csv_row(device: dict, client) -> dict:
    ...
    dep_name = lookup_dept_name(ext_number_last3)
